    ...
    def fetch_components(self):
        ...
        try:
            if self.chosen_platform == "intel":
                self.mobos = db_service.get_products_by_category_and_brand("mobo", "intel")
            else:
                self.mobos = db_service.get_products_by_category_and_brand("mobo", "amd")
        ...
        # Cargar CPUs
        try:
            self.cpus = db_service.get_products_by_category_and_brand("cpu", self.chosen_platform)
